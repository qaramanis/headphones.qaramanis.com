...
export default function Ipod() {
  return (
    <div className="relative flex flex-col justify-between items-center w-[313px] h-[500px] bg-gradient-to-br from-[#425062] via-[#353b47] to-[#353b47] rounded-2xl pt-[12px] pb-[24px] border border-[#1F1E26] overflow-visible drop-shadow-lg">
